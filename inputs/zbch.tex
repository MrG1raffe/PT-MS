...
\begin{Ex}
    ...
    \begin{multline*}
        ...
        \dfrac{1}{\pi} \left. \arctg \left( \dfrac{x}{\gamma n} \right) \right|\limits_{n(a+\varepsilon)}^{+\infty} + 
        \dfrac{1}{\pi} \left. \arctg \left( \dfrac{x}{\gamma n} \right) \right|\limits_{-\infty}^{n(a - \varepsilon)} = \\
